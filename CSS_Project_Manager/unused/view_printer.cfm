...
<td align="left">Printer Tickets</td></tr>
<tr height="20px" style="color:#000000; font-size: 10px;">
<td>This is a table showing tickets which are currently at the printer.
<cfif '#Get_projects_printer.recordcount#' EQ 0><br><br><p style="font-size:12px"><span style="font-weight: bold">Note</span>: Currently, there are no records in this table.</p>
<cfelse></td></tr>
</table>
...
<cfoutput query="Get_projects_printer">
