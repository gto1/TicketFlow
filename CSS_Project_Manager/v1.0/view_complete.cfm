...
<td align="left">Complete Tickets</td>
</tr>
<tr height="20px" style="color:#000000; font-size: 10px;">
<td>This is a table showing tickets for which the work has been completed and put into production.
<cfif '#Get_projects_complete.recordcount#' EQ 0><br><br><p style="font-size:12px"><span style="font-weight: bold">Note</span>: Currently, there are no records in this table.</p>
<cfelse></td></tr>
</table>
...
<cfoutput query="Get_Projects_complete">
...
<td align="left" valign="top"><a href="#w_fname#@psu.edu" title="Assigned Ticket">#w_fname#</a></td></tr>
</cfoutput>
</cfif>
</table>
<!--end tickets table -->
